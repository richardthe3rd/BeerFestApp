...
public class StarRatingTest {
    ...
    public void comparesEqual() {
        assertThat(new StarRating(3), comparesEqualTo(new StarRating(3)));
    }

    @Test
    public void comparesLessThan() {
        assertThat(new StarRating(1), lessThan(new StarRating(5)));
    }

    @Test
    public void comparesGreaterThan() {
        assertThat(new StarRating(5), greaterThan(new StarRating(2)));
    }
}
