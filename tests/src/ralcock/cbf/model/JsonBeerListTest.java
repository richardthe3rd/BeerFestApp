...
public class JsonBeerListTest extends AndroidTestCase {
    ...
    private final Beer fBrewery1Beer1 = new Beer("1", "BEER_ONE", 1.1f, "BEER_ONE_NOTES", "BEER_ONE_STATUS", fBrewery1);
    private final Beer fBrewery1Beer2 = new Beer("2", "BEER_TWO", 2.2f, "BEER_TWO_NOTES", "BEER_TWO_STATUS", fBrewery2);
    private final Beer fBrewery2Beer3 = new Beer("3", "BEER_THREE", 3.3f, "BEER_THREE_NOTES", "BEER_THREE_STATUS", fBrewery2);
